# -*- coding: utf-8 -*-
"""
Created on Mon Nov 13 19:40:21 2017
...
from ibapi import wrapper     #导入wrapper而不是wrapper.EWrapper是因为EClient需要wrapper初始化
...
#                        level=logging.INFO,
    ...
    '''INFO 以上级别添加到log文件，ERROR以上级别同时输出到屏幕'''
...
#                               "1 M", "1 day", "MIDPOINT", 1, 1, False, [])
        self.reqHistoricalData(4101, ContractSamples.USStockWithPrimaryExch(), queryTime,
                               "1 M", "1 day", "MIDPOINT", 1, 1, False, [])
...
#    VolumeCondition.__setattr__ = utils.setattr_log
    ...
    logging.debug("This is the begining!")
    ...
    try:
        ...
        # ! [connect]
        logging.debug("This is before run!")
        app.run()
    except:
        raise
    finally:
